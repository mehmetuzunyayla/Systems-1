# Contributing to Web Based File Explorer for Linux
...
- These two operations can be change according to make system better 
- 1. Edit File button shouldn't be seen in folders context manager
- 2. Files and Folders are in the same color in the page 
